...
for(var b in a){var c=a[b];this.elements[c.id]=c.instance}},_renderHtmlTemplate:function(a){if(!(this.options.htmlTemplate==null||this.options.htmlTemplate=="")){$(b).trigger(UIComponentEvents.STARTRENDERING);var b=this.element;if(a!=null)b=typeof a!=="string"?a:$(a);b.html(this.options.htmlTemplate);$(b).trigger(UIComponentEvents.FINISHRENDERING)}},getChild:function(a){return $(a,this.element)},addChild:function(a){a=$(a).appendTo(this.element);var b=a.attr("id");if(b!=null)this.elements.push[b]=
a;return a},__currentState:null,currentState:function(a){if(arguments.length==0)return this.__currentState;for(var b=this.__currentState,c=a.split(" "),d=[],e=1;e<arguments.length;e++)d.push(arguments[e]);if(this.states!=null){this.__currentState=c[c.length-1];this.states._exitState!=null?this.states._exitState.apply(this,[a]):$(this.element).trigger(StateEvents.EXITSTATE);this.states._enterState!=null?this.states._enterState.apply(this,[a]):$(this.element).trigger(StateEvents.ENTERSTATE);for(var f in c){if(b==
null)b="";d.splice(0,0,b);this.states[c[f]].apply(this,d);b=c[f];d.splice(0,1)}this.states._endState!=null?this.states._endState.apply(this,[a]):$(this.element).trigger(StateEvents.ENDSTATE)}return false},_commitProperties:function(){},invalidateProperties:function(){this._commitProperties()},_updateView:function(){},invalidateView:function(){this._updateView()},destroy:function(){$.Widget.prototype.destroy.apply(this,arguments)}});
